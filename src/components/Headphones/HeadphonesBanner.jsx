...
//     return (
//         <>
//             <section className="pt-[121px] pb-[400px] px-[658px] bg-[url('image/Headphones-banner.png')] bg-no-repeat bg-cover">
...
//   // Banner images (add as many as you like)
//   const banners = [
...
//           <div key={banner.id}>
//             <div
//               className="h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px] bg-center bg-cover flex items-center justify-center"
...
function HeadphonesBanner() {
  useEffect(() => {
    AOS.init({ duration: 1000, once: true }); // AOS animation initialization
  }, []);
    ...
    <section className="relative w-full">
      <Slider {...settings}>
        {banners.map((banner) => (
          <div key={banner.id}>
            <div
              className="h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px] bg-center bg-cover flex items-center justify-center relative"
              style={{ backgroundImage: `url(${banner.img})` }}
              data-aos="fade-up"
            >
              {/* Content */}
